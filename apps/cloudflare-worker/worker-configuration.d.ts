/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5a7c2fd5efcdbeeee7a2587b75479b1)
// Runtime types generated with workerd@1.20250902.0 2025-03-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		PTT_CACHE: KVNamespace;
		...
		ACCESS_PERMISSION_PREFIX: string;
		TENANT_ADMIN_PERMISSION: string;
		...
		CLOUDFLARE_TUNNEL_FRONTEND_TOKEN: string;
		WEBM_DEBUG: string;
		JSON_DEBUG: string;
		CHANNEL_OBJECTS: DurableObjectNamespace<import("./src/index").PTTChannelDurableObject>;
		PTT_DB: D1Database;
